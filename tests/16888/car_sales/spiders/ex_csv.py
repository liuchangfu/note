...
# with open('names.csv', 'w', newline='') as csvfile1:
...
# with open('cars.csv', 'w', newline='') as csvfile2:
...
dates = [{'date': None, 'monthly_sales': None, 'share_manufacturers': None, 'sales_ranking_month': None,
...
# for date in dates:
#     with open('cars2.csv', 'w', newline='') as csvfile3:
#         fieldnames = ['date', 'monthly_sales', 'share_manufacturers', 'sales_ranking_month', 'maker_ranking',
#                       'ranking_compact_cars']
